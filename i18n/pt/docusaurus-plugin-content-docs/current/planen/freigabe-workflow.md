...
# Fluxo de Aprovação: Do Rascunho ao Plano Vinculativo

Um plano de turnos passa, no Klacks, por fases claramente definidas — para que seja sempre inequívoco aquilo em que a equipa se pode basear.

## Como funciona

O plano percorre quatro fases:
...
- **Confirmar** pode ser feito por qualquer pessoa com sessão iniciada.
- **Aprovar** (e retirar a aprovação) exige a função **Supervisor** ou **Admin** — respetivamente por dia e por grupo.
- **Concluir** um período (e a sua posterior reabertura) está reservado **exclusivamente ao Admin**.
