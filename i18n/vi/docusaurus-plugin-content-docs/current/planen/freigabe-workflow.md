...
# Quy trình phê duyệt: Từ bản dự thảo đến kế hoạch ràng buộc

Một lịch làm việc trong Klacks trải qua các giai đoạn được xác định rõ ràng — để tại bất kỳ thời điểm nào cũng luôn rõ ràng điều mà cả nhóm có thể tin cậy.

## Cách hoạt động

Kế hoạch đi qua bốn giai đoạn:
...
- **Xác nhận** có thể được thực hiện bởi bất kỳ người dùng đã đăng nhập nào.
- **Phê duyệt** (và rút lại phê duyệt) cần vai trò **Supervisor** hoặc **Admin** — cho từng ngày và từng nhóm.
- **Hoàn tất** một kỳ (và việc mở lại sau đó) chỉ dành riêng cho **Admin**.
