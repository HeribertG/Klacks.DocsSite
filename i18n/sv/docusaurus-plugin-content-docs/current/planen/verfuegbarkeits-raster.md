...
- **Färgkodning:** Lördagar, söndagar och helgdagar får egna bakgrundsfärger, så att helger och arbetsfria dagar syns direkt.
...
- De registrerade tillgängligheterna flödar direkt in i [Autoplanering: schemat på sekunder](../planen/auto-planung.md): algoritmen planerar enbart inom de anmälda tiderna.
