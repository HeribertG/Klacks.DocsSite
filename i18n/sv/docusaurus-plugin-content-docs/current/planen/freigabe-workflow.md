...
# Godkännandeflöde: från utkast till bindande schema

Ett schema genomgår i Klacks tydligt definierade steg — så att det alltid är entydigt vad teamet kan lita på.

## Så fungerar det

Schemat vandrar genom fyra steg:
...
- **Bekräfta** får vem som helst som är inloggad göra.
- **Godkänna** (och dra tillbaka godkännandet) kräver rollen **Supervisor** eller **Admin** — i respektive fall per dag och grupp.
- **Avsluta** en period (och senare återöppna den) är förbehållet **enbart Admin**.
