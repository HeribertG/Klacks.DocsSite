...
# Flux de aprobare: de la ciornă la plan obligatoriu

Un plan de servicii parcurge în Klacks etape clar definite — astfel încât să fie oricând clar pe ce se poate baza echipa.

## Cum funcționează

Planul parcurge patru etape:
...
- **Confirmarea** o poate face orice persoană autentificată.
- **Aprobarea** (și retragerea aprobării) necesită rolul de **Supervizor** sau **Admin** — separat pentru fiecare zi și grup.
- **Încheierea** unei perioade (și redeschiderea ei ulterioară) este rezervată **exclusiv rolului de Admin**.
