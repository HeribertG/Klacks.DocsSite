...
# Workflow di approvazione: dalla bozza al piano vincolante

In Klacks un piano di servizio attraversa fasi chiaramente definite — così è sempre inequivocabile su cosa il team può contare.

## Come funziona

Il piano passa attraverso quattro fasi:
...
- **Confermare** può farlo qualsiasi persona autenticata.
- **Approvare** (e ritirare l'approvazione) richiede il ruolo **Supervisor** o **Admin** — rispettivamente per giorno e gruppo.
- **Concludere** un periodo (e la successiva riapertura) è riservato **esclusivamente all'Admin**.
