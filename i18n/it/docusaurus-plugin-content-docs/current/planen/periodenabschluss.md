...
La pagina è suddivisa in tre schede: **Periodi**, **Esportazioni** e **Registro**.
...
- I turni non chiusi **non** vengono esportati. Klacks vi avvisa se solo una parte dei turni è chiusa («x di y turni sono chiusi»).
- Se per un periodo è già stata generata un'esportazione, Klacks avvisa in caso di ulteriori modifiche: potreste causare discrepanze con la contabilità.
- La riapertura di un periodo sigillato può influire sui conteggi — per questo Klacks chiede conferma e richiede una motivazione.
