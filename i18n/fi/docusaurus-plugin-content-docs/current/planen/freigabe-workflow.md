...
# Hyväksymisprosessi: luonnoksesta sitovaan suunnitelmaan

Työvuorosuunnitelma käy Klacksissa läpi selkeästi määritellyt vaiheet — jotta on aina yksiselitteistä, mihin tiimi voi luottaa.

## Näin se toimii

Suunnitelma etenee neljän vaiheen läpi:
...
- **Vahvistaminen** on sallittu jokaiselle kirjautuneelle henkilölle.
- **Hyväksyminen** (ja hyväksynnän peruminen) vaatii **Supervisor**- tai **Admin**-roolin — kussakin tapauksessa päivä- ja ryhmäkohtaisesti.
- **Jakson sulkeminen** (ja myöhempi uudelleenavaaminen) on varattu **yksinomaan Adminille**.
