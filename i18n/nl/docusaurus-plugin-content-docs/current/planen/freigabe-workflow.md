...
# Goedkeuringsworkflow: van concept naar bindende planning

Een dienstrooster doorloopt in Klacks duidelijk gedefinieerde fasen — zodat altijd eenduidig is waarop het team kan vertrouwen.

## Zo werkt het

De planning doorloopt vier fasen:
...
- **Bevestigen** mag elke aangemelde persoon.
- **Goedkeuren** (en de goedkeuring intrekken) vereist de rol **Supervisor** of **Admin** — telkens per dag en groep.
- **Afsluiten** van een periode (en het latere heropenen) is **uitsluitend voorbehouden aan Admin**.
