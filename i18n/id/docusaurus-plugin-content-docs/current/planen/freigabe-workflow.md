...
# Alur Persetujuan: Dari Draf menjadi Jadwal Mengikat

Sebuah jadwal kerja melalui tahapan-tahapan yang jelas didefinisikan di Klacks — sehingga selalu jelas apa yang bisa diandalkan oleh tim.

## Cara Kerjanya

Jadwal berjalan melalui empat tahap:
...
- **Konfirmasi** dapat dilakukan oleh setiap orang yang login.
- **Persetujuan** (dan penarikan persetujuan) memerlukan peran **Supervisor** atau **Admin** — masing-masing per hari dan grup.
- **Penutupan** suatu periode (dan pembukaan kembali di kemudian hari) hanya diperuntukkan bagi **Admin**.
