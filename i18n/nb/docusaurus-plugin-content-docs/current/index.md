...
- [Dashbordet ditt: Alt på ett blikk](./erste-schritte/ihr-dashboard.md) — Startsiden i Klacks med fire fritt sorterbare seksjoner: Oversikt, Dekning & bekreftelse, Ressurser og Lokasjoner

**Planlegging**
- [Autoplanlegging: Ett klikk, resten kjører i bakgrunnen](./planen/auto-planung.md) — Beregning i bakgrunnen, mens du tar deg av andre ting
...
- [Tilgjengelighetsrutenettet: Hvem som er tilgjengelig når](./planen/verfuegbarkeits-raster.md) — Registrert time- eller dagsnøyaktig, for egne og eksterne medarbeidere
- [Livssyklusen til en vakt: Fra bestilling til segment](./planen/schicht-lebenszyklus.md) — Fra redigerbar bestilling til forseglet kontrakt og planbar vakt
