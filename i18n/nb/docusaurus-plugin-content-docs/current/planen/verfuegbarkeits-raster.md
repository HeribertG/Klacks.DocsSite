...
- **Fargekoding:** De definerte helgedagene og helligdagene får egne bakgrunnsfarger, slik at fridager skiller seg ut umiddelbart. Hvilke ukedager som regnes som helg, er konfigurerbart — det er ikke overalt lørdag og søndag (f.eks. sabbat eller andre landsspesifikke hviledager).
...
- De registrerte tilgjengelighetene går direkte inn i [Autoplanlegging: Ett klikk, resten kjører i bakgrunnen](../planen/auto-planung.md): Algoritmen planlegger bare innenfor de meldte tidene.
