...
- **Color coding:** Saturdays, Sundays, and public holidays get their own background colors, so weekends and non-working days stand out immediately.
...
- The availabilities you record feed directly into [Auto-Planning: A Schedule in Seconds](../planen/auto-planung.md): the algorithm only schedules within the reported time windows.
