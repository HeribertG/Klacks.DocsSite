...
# Schvalovací workflow: Od návrhu k závaznému plánu

Plán služeb prochází v Klacks jasně definovanými stupni — aby bylo kdykoli jednoznačné, na co se tým může spolehnout.

## Jak to funguje

Plán prochází čtyřmi stupni:
...
- **Potvrdit** smí každá přihlášená osoba.
- **Schválit** (a schválení zpět odvolat) vyžaduje roli **Supervisor** nebo **Admin** — vždy pro daný den a skupinu.
- **Uzavřít** období (a pozdější opětovné otevření) je vyhrazeno **výhradně administrátorovi**.
