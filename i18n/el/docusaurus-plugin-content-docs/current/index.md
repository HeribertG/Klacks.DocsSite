...
# Καλώς ήρθατε στην τεκμηρίωση του Klacks

Το **Klacks** είναι η πλατφόρμα ανοιχτού κώδικα για τον προγραμματισμό προσωπικού σε επιχειρήσεις βαρδιών και αποστολών: αυτόματος προγραμματισμός υπηρεσιών, βελτιστοποίηση διαδρομών, έλεγχος μέσω βοηθού AI — On-Premise, με το μοντέλο AI της επιλογής σας. Για φορείς κατ' οίκον φροντίδας, νοσοκομεία, επιχειρήσεις ασφαλείας, καθαρισμού και εφοδιαστικής αλυσίδας.

Αυτό το wiki εξηγεί σε μικρές δόσεις πώς λειτουργεί το Klacks. Κάθε σελίδα διαβάζεται σε λίγα λεπτά — και όλα μπορούν να δοκιμαστούν αμέσως στο δημόσιο Playground.
...
**Σχετικά με το Klacks**
- [Η φιλοσοφία πίσω από το Klacks](./ueber-klacks/philosophie.md) — Κυριαρχία δεδομένων, ελεύθερη επιλογή AI, ανοιχτός κώδικας

**Πρώτα βήματα**
- [Εγκατάσταση και Playground](./erste-schritte/installation-und-playground.md) — Σε λίγα λεπτά με ένα Klacks σε λειτουργία
...
**Προγραμματισμός**
- [Αυτόματος προγραμματισμός: Ένα κλικ, το υπόλοιπο τρέχει στο παρασκήνιο](./planen/auto-planung.md) — Ο υπολογισμός γίνεται στο παρασκήνιο, ενώ εσείς ασχολείστε με άλλα πράγματα
- [Το πλέγμα προγράμματος: Ο διαδραστικός σας πίνακας χρόνου](./planen/plan-raster.md) — Ο διαδραστικός πίνακας χρόνου με μεταφορά-και-απόθεση
- [Αρθρωτός προγραμματισμός: Διαίρει και βασίλευε](./planen/modulare-planung.md) — Διαίρεση μεγάλων προγραμμάτων, χωρίς διπλές κρατήσεις
...
- [Απουσίες με μια ματιά](./optimieren/absenzen-im-blick.md) — Διακοπές και ασθένεια ως επισκόπηση Gantt
- [Οθόνη παρακολούθησης πόρων](./optimieren/ressourcen-monitor.md) — Φόρτος εργασίας με μια ματιά
