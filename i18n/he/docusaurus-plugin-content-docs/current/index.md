...
# ברוכים הבאים לתיעוד של Klacks

**Klacks** היא הפלטפורמה הקוד-פתוח לתכנון כוח אדם בעסקי משמרות ותפעול: תכנון משמרות אוטומטי, אופטימיזציית מסלולים, שליטה באמצעות עוזר בינה מלאכותית - On-Premise, עם מודל ה-AI לבחירתכם. עבור ספיטקס (Spitex), בתי חולים, עסקי אבטחה, ניקיון ולוגיסטיקה.

ויקי זה מסביר בפרקים קטנים כיצד Klacks פועלת. כל עמוד נקרא תוך דקות ספורות - וכל דבר ניתן לנסות מיד ב-Playground הציבורי.
...
**אודות Klacks**
- [הפילוסופיה מאחורי Klacks](./ueber-klacks/philosophie.md) - ריבונות נתונים, חופש בחירת בינה מלאכותית, קוד פתוח

**צעדים ראשונים**
- [התקנה ו-Playground](./erste-schritte/installation-und-playground.md) - תוך דקות ספורות ל-Klacks פועלת
...
**תכנון**
- [תכנון אוטומטי: לחיצה אחת, השאר רץ ברקע](./planen/auto-planung.md) - חישוב ברקע, בזמן שאתם מתפנים לדברים אחרים
- [גריד התכנון: מטריצת הזמן האינטראקטיבית שלכם](./planen/plan-raster.md) - מטריצת הזמן האינטראקטיבית עם גרירה ושחרור
- [תכנון מודולרי: הפרד ומשול](./planen/modulare-planung.md) - חלוקת תוכניות גדולות, ללא הזמנות כפולות
...
- [היעדרויות במבט](./optimieren/absenzen-im-blick.md) - חופשה ומחלה כתרשים גאנט
- [Ressourcen Monitor](./optimieren/ressourcen-monitor.md) - ניצולת במבט אחד
