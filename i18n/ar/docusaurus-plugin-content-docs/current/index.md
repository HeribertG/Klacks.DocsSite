...
# مرحبًا بكم في توثيق Klacks

**Klacks** هي المنصة مفتوحة المصدر لتخطيط القوى العاملة في مؤسسات المناوبات والخدمات الميدانية: تخطيط الخدمات تلقائيًا، وتحسين الجولات، والتحكم عبر مساعد ذكاء اصطناعي — على بنيتكم التحتية الخاصة (On-Premise)، وبنموذج الذكاء الاصطناعي الذي تختارونه. مخصصة لمؤسسات الرعاية الصحية المنزلية (Spitex) والمستشفيات وخدمات الأمن والتنظيف والخدمات اللوجستية.

يشرح هذا الدليل كيفية عمل Klacks على شكل أجزاء صغيرة سهلة الفهم. تستغرق قراءة كل صفحة بضع دقائق فقط — ويمكن تجربة كل شيء فورًا في بيئة التجربة العامة Playground.
...
**عن Klacks**
- [الفلسفة وراء Klacks](./ueber-klacks/philosophie.md) — سيادة البيانات، حرية اختيار الذكاء الاصطناعي، المصدر المفتوح

**الخطوات الأولى**
- [التثبيت وبيئة التجربة](./erste-schritte/installation-und-playground.md) — إلى نسخة Klacks عاملة خلال دقائق قليلة
...
**التخطيط**
- [التخطيط التلقائي: نقرة واحدة، والباقي يعمل في الخلفية](./planen/auto-planung.md) — الحساب يعمل في الخلفية بينما تنشغلون بأمور أخرى
- [شبكة التخطيط: مصفوفتكم الزمنية التفاعلية](./planen/plan-raster.md) — المصفوفة الزمنية التفاعلية بالسحب والإفلات
- [التخطيط المعياري: فرّق تسد](./planen/modulare-planung.md) — تقسيم الخطط الكبيرة دون حجوزات مزدوجة
...
- [نظرة على الغيابات](./optimieren/absenzen-im-blick.md) — الإجازات والمرض في عرض جانت (Gantt) شامل
- [مراقب الموارد](./optimieren/ressourcen-monitor.md) — الاستغلال بنظرة واحدة
