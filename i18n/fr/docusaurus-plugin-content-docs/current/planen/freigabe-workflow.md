...
# Workflow de validation : de l'ébauche au plan définitif

Dans Klacks, un plan de service traverse des étapes clairement définies — afin qu'il soit à tout moment évident sur quoi l'équipe peut compter.

## Comment ça marche

Le plan passe par quatre étapes :
...
- **Confirmer** est possible pour toute personne connectée.
- **Approuver** (et retirer une approbation) requiert le rôle **Superviseur** ou **Admin** — respectivement par jour et par groupe.
- **Clôturer** une période (et la rouvrir par la suite) est **réservé exclusivement aux administrateurs**.
