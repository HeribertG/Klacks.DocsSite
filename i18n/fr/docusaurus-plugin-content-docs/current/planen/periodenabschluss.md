...
La page est organisée en trois onglets : **Périodes**, **Exports** et **Journal**.
...
- Les services non clôturés ne sont **pas** exportés. Klacks vous avertit si seule une partie des services est clôturée (« x services sur y sont clôturés »).
- Si un export a déjà été généré pour une période, Klacks vous avertit en cas de nouvelles modifications : elles peuvent créer des écarts avec la comptabilité.
- La réouverture d'une période scellée peut avoir un impact sur les décomptes — Klacks demande donc confirmation et exige un motif.
- Vous accédez à la clôture de période via l'icône de clôture dans la navigation de gauche.
