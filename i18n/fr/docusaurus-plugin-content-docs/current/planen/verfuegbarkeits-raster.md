...
- **Codage couleur :** les samedis, dimanches et jours fériés ont leurs propres couleurs de fond, pour repérer immédiatement les week-ends et jours non travaillés.
...
- Les disponibilités saisies alimentent directement la [Planification automatique : le plan en quelques secondes](../planen/auto-planung.md) : l'algorithme ne planifie qu'à l'intérieur des plages annoncées.
