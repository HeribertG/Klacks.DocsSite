...
- [가용성 그리드: 누가 언제 투입 가능한지](./planen/verfuegbarkeits-raster.md) — 시간 또는 일 단위로 정확하게 기록되는, 자사 및 외부 직원의 가용성
- [근무의 라이프사이클: 주문에서 조각까지](./planen/schicht-lebenszyklus.md) — 편집 가능한 주문에서 봉인된 계약을 거쳐 계획 가능한 근무까지
