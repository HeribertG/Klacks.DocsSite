...
# Godkendelsesworkflow: Fra udkast til bindende plan

En vagtplan gennemløber i Klacks klart definerede trin — så det til enhver tid er entydigt, hvad teamet kan regne med.

## Sådan fungerer det

Planen bevæger sig gennem fire trin:
...
- **Bekræfte** må enhver logget ind person.
- **Godkende** (og trække godkendelsen tilbage) kræver rollen **Supervisor** eller **Admin** — hver for sig pr. dag og gruppe.
- **Afslutte** en periode (og senere genåbne den) er **udelukkende forbeholdt Admin**.
